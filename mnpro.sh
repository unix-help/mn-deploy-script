...
COIN_DAEMON='/usr/local/bin/mnprod'
...
#Generating Random Password for mnprod RPC
...
addnode=45.77.131.227:7000
addnode=207.246.126.81:7000
EOF
}
...
function important_information() {
 ...
 echo -e "Check if $COIN_NAME is running by using the following command: ${RED}systemctl status MNPRO.service${NC}"
 echo -e "================================================================================================================================"
}
